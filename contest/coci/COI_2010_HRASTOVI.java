...
public class COI_2010_HRASTOVI {
	...
	public static void main (String[] args) throws IOException {
		...
		for (int i = 0; i < m; i++) {
			sum[i] += search(false, r[i].y2, r[i].x2, false)
					- search(false, r[i].y2, r[i].x1, true);
			sum[i] += search(false, r[i].y1, r[i].x2, false)
