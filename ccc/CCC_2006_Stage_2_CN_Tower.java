...
public class CCC_2006_Stage_2_CN_Tower {
	...
	public static void main (String[] args) {
		...
		// System.out.println((360.0d-biggest)/360.0d*72.0d*60.0d);
		double answer = (360.0d - biggest) / 360.0d * 72.0d * 60.0d
				- (int) ((360.0d - biggest) / 360.0d * 72.0d * 60.0d) < 0.0000001d ? (int) ((360.0d - biggest) / 360.0d * 72.0d * 60.0d)
				: Math.ceil(Math
						.ceil((360.0d - biggest) / 360.0d * 72.0d * 60.0d));
