/*
 * Using Knuth's Optimization to reduce the runtime of this dynamic programming algorithm from O(N^3) to O(N^2). The asymptotic time complexity can be proven by analyzing the telescoping series.
 *
