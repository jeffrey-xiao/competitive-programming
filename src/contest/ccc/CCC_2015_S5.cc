...
// If we sort the M pies in increasing order, we can notice that we will choose the low sugar
// content pies to "skip" and the high sugar content pies to "take

// Now let us define our DP state to be dp[i][j][k][b] where i represents the position of the
// current pie from N you are on, j-k represents the interval of M you can take/skip, and b
// represents if you eat a pie or not
